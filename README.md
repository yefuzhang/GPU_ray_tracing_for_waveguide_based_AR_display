...
This repository accompanies our paper on **Fast evaluation of waveguide AR displays with an open-source GPU ray-tracing method** (*https://doi.org/10.1364/OE.584116*).  
...
All design parameters—periods, positions, and diffraction directions—are defined here.
...
- Packages:  
  ```bash
  pip install numpy numba matplotlib colour-science cv2 shapely scipy math gdown
